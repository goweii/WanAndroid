 ...
 */
public class KnowledgeNavigationFragment extends BaseFragment<BasePresenter, FragmentKnowledgeNavigationBinding> implements RvScrollTopUtils.ScrollTop {
    ...
    @Nullable
    @Override
    protected FragmentKnowledgeNavigationBinding initViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return FragmentKnowledgeNavigationBinding.inflate(inflater, container, false);
    }
