...
class MultiStateUtils {
    companion object {
        ...
        @JvmStatic
        @JvmOverloads
        fun toEmpty(view: MultiStateView, force: Boolean = false, icon: Int? = R.drawable.ic_empty, text: String? = view.context.getString(R.string.nothing)) {
        ...
        @JvmStatic
        @JvmOverloads
        fun toError(view: MultiStateView, force: Boolean = false, icon: Int? = R.drawable.ic_error, text: String? = view.context.getString(R.string.how_did_it_go_wrong_again)) {
            if (force || view.viewState != MultiStateView.VIEW_STATE_CONTENT) {
