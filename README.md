...
**之前被人改成马甲包上架到小米应用商店，现在已经下架但是处于无法申诉状态。所以从下面三个渠道下载安装时还是会提示高危应用，这个属于之前被下架的后遗症，可放心安装。**
...
master分支为Java/Kotlin混合开发，kt占比大约为8%。后面发现部分同学在找纯Java的代码版本，所以新建了java和kotlin两个分支。感兴趣的同学可以fork对应的语言分支翻译后提pr，通过合并的会在下面注明分支贡献者。
...
[完整更新日志](https://github.com/goweii/WanAndroid/blob/master/CHANGELOG.md)
